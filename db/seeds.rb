...
Bookcharacter.create(character_id: miller.id, book_id: book_one.id)
...
Bookcharacter.create(character_id: julie_mao.id, book_id: book_one.id)
...
Bookcharacter.create(character_id: fred_johnson.id, book_id: book_one.id)
Bookcharacter.create(character_id: fred_johnson.id, book_id: book_two.id)
Bookcharacter.create(character_id: fred_johnson.id, book_id: book_three.id)
Bookcharacter.create(character_id: fred_johnson.id, book_id: book_four.id)
Bookcharacter.create(character_id: fred_johnson.id, book_id: book_five.id)
Bookcharacter.create(character_id: fred_johnson.id, book_id: book_six.id)
...
Bookcharacter.create(character_id: prax.id, book_id: book_two.id)
Bookcharacter.create(character_id: prax.id, book_id: book_six.id)


mei = Character.create(name: "Mei Meng", description: "Daughter of Prax.", location: "The Outer Planets")
Bookcharacter.create(character_id: mei.id, book_id: book_three.id)
Bookcharacter.create(character_id: mei.id, book_id: book_six.id)
...
Bookcharacter.create(character_id: debaca.id, book_id: book_three.id)
Bookcharacter.create(character_id: debaca.id, book_id: book_six.id)
...
Bookcharacter.create(character_id: michio.id, book_id: book_three.id)
Bookcharacter.create(character_id: michio.id, book_id: book_six.id)
...
Bookcharacter.create(character_id: merton.id, book_id: book_two.id)
Bookcharacter.create(character_id: merton.id, book_id: book_four.id)


maneo = Character.create(name: "Manéo \"Néo\" Jung-Espinoza", description: "A young Belter from Ceres.", location: "The Outer Planets")
Bookcharacter.create(character_id: maneo.id, book_id: book_three.id)
...
Bookcharacter.create(character_id: marco.id, book_id: book_five.id)
Bookcharacter.create(character_id: marco.id, book_id: book_six.id)
...
Bookcharacter.create(character_id: filip.id, book_id: book_five.id)
Bookcharacter.create(character_id: filip.id, book_id: book_six.id)
...
Bookcharacter.create(character_id: drummer.id, book_id: book_five.id)
Bookcharacter.create(character_id: drummer.id, book_id: book_six.id)
Bookcharacter.create(character_id: drummer.id, book_id: book_seven.id)
Bookcharacter.create(character_id: drummer.id, book_id: book_eight.id)
...
Bookcharacter.create(character_id: draper.id, book_id: book_two.id)
Bookcharacter.create(character_id: draper.id, book_id: book_four.id)
Bookcharacter.create(character_id: draper.id, book_id: book_five.id)
Bookcharacter.create(character_id: draper.id, book_id: book_six.id)
Bookcharacter.create(character_id: draper.id, book_id: book_seven.id)
Bookcharacter.create(character_id: draper.id, book_id: book_eight.id)
...
Bookcharacter.create(character_id: fayez.id, book_id: book_four.id)

emil = Character.create(name: "Emil Sauveterre", description: "The captain of the MCRN Barkeith.", location: "Mars")
Bookcharacter.create(character_id: emil.id, book_id: book_five.id)
...
Bookcharacter.create(character_id: kit.id, book_id: book_eight.id)
Bookcharacter.create(character_id: kit.id, book_id: book_nine.id)
...
Bookcharacter.create(character_id: havelock.id, book_id: book_one.id)
Bookcharacter.create(character_id: havelock.id, book_id: book_four.id)
...
Bookcharacter.create(character_id: avasarala.id, book_id: book_two.id)
Bookcharacter.create(character_id: avasarala.id, book_id: book_four.id)
Bookcharacter.create(character_id: avasarala.id, book_id: book_five.id)
Bookcharacter.create(character_id: avasarala.id, book_id: book_six.id)
Bookcharacter.create(character_id: avasarala.id, book_id: book_seven.id)
...
Bookcharacter.create(character_id: clarissa_mao.id, book_id: book_three.id)
Bookcharacter.create(character_id: clarissa_mao.id, book_id: book_five.id)
Bookcharacter.create(character_id: clarissa_mao.id, book_id: book_six.id)
Bookcharacter.create(character_id: clarissa_mao.id, book_id: book_seven.id)
...
Bookcharacter.create(character_id: okoye.id, book_id: book_four.id)
Bookcharacter.create(character_id: okoye.id, book_id: book_eight.id)
Bookcharacter.create(character_id: okoye.id, book_id: book_nine.id)
...
Bookcharacter.create(character_id: anna.id, book_id: book_three.id)
Bookcharacter.create(character_id: anna.id, book_id: book_six.id)
...
Bookcharacter.create(character_id: nono.id, book_id: book_three.id)
Bookcharacter.create(character_id: nono.id, book_id: book_six.id)
...
Bookcharacter.create(character_id: winston_duarte.id, book_id: book_five.id)
Bookcharacter.create(character_id: winston_duarte.id, book_id: book_seven.id)
Bookcharacter.create(character_id: winston_duarte.id, book_id: book_eight.id)
Bookcharacter.create(character_id: winston_duarte.id, book_id: book_nine.id)
...
Bookcharacter.create(character_id: teresa_duarte.id, book_id: book_seven.id)
Bookcharacter.create(character_id: teresa_duarte.id, book_id: book_eight.id)
Bookcharacter.create(character_id: teresa_duarte.id, book_id: book_nine.id)
...
Bookcharacter.create(character_id: cortazar.id, book_id: book_seven.id)
Bookcharacter.create(character_id: cortazar.id, book_id: book_eight.id)
...
Bookcharacter.create(character_id: singh.id, book_id: book_seven.id)
...
Bookcharacter.create(character_id: trejo.id, book_id: book_seven.id)
Bookcharacter.create(character_id: trejo.id, book_id: book_eight.id)
Bookcharacter.create(character_id: trejo.id, book_id: book_nine.id)
...
Bookcharacter.create(character_id: tanaka.id, book_id: book_seven.id)
Bookcharacter.create(character_id: tanaka.id, book_id: book_nine.id)
...
Bookcharacter.create(character_id: bisset.id, book_id: book_eight.id)
Bookcharacter.create(character_id: bisset.id, book_id: book_nine.id)
...
Bookcharacter.create(character_id: houston.id, book_id: book_eight.id)
Bookcharacter.create(character_id: houston.id, book_id: book_nine.id)
...
Bookcharacter.create(character_id: ekko.id, book_id: book_nine.id)
...
Bookcharacter.create(character_id: imvic.id, book_id: book_nine.id)
